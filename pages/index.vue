...
const shopWithPromote = shuffle(shopsAll.value.filter(shop => promoteShopList.includes(shop.id)))
...
const shopShuffle = [].concat(shopWithPromote, shopWithImage, shopNoImage)
